...
<script>
    ...
    $(function ()
    {
        ...
        $("div.productsAsideCategorys").mouseenter(
            function()
            {
                var cid = $(this).attr("cid");
                showProductsAsideCategorys(cid);
        ...
        $("div.productsAsideCategorys").mouseleave(
            function()
            {
                var cid = $(this).attr("cid");
                hideProductsAsideCategorys(cid);
        ...
        $("div.rightMenu span").mouseenter(
            function ()
            {
                var left = $(this).position().left;//获取相对父元素的位置
...
<div class="categoryWithCarousel">
    <div class="headbar show1">
        ...
        <div class="rightMenu">
            ...
            <c:forEach items="${categories}" varStatus="status" var="c">
