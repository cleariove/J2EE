...
<script>
    $(function () {
        $("button.orderPageCheckOrderItems").click(
            function () {
            ...
            <tbody>
                <c:forEach items="${orders}" var="o">
                    <tr>
                        ...
                        <td>${o.statusDesc}</td>
                        <td>
                            <f:formatNumber type="number" value="${o.total}" minFractionDigits="2"/>
                        </td>
                        <td align="center">${o.totalNumber}</td>
                        <td align="center">${o.user.name}</td>
                        <td>
                            <f:formatDate value="${o.createDate}" pattern="yyyy-MM-dd HH:mm:ss" />
                        </td>
                        <td>
                            <f:formatDate value="${o.payDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </td>
                        <td>
                            <f:formatDate value="${o.deliveryDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </td>
                        <td>
                            <f:formatDate value="${o.confirmDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </td>
                        <td>
