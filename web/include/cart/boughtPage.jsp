...
<div class="boughtDiv">
    <div class="orderType">
        <div class="selectedOrderType">
            <a href="#nowhere" orderStatus="all">
                所有订单
            </a>
        </div>
        <div>
        ...
        <div>
            <a orderStatus="waitReview" href="#nowhere" class="noRightborder">
                待评价
            </a>
        </div>
        <div>
                        ...
                        <c:if test="${status.count == 1}">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
                                ...
                                <c:if test="${o.status=='waitDelivery' }">
                                    <span>待发货</span>
                                    <button class="btn btn-info btn-sm ask2delivery" link="admin_order_delivery?oid=${o.id}">
                                        催卖家发货
                                    </button>
                                </c:if>
